...
dofile(minetest.get_modpath("castle").."/castle_decoplayer.lua")
dofile(minetest.get_modpath("castle").."/castle_towerwall.lua")
dofile(minetest.get_modpath("castle").."/castle_strongdefensewall.lua")
dofile(minetest.get_modpath("castle").."/castle_towerwalldefense.lua")
dofile(minetest.get_modpath("castle").."/castle_towerwall2ab.lua")
dofile(minetest.get_modpath("castle").."/castle_towerwalldefense2ab.lua")
dofile(minetest.get_modpath("castle").."/castle_towerwallroof.lua")
dofile(minetest.get_modpath("castle").."/castle_towerwallroof2ab.lua")
dofile(minetest.get_modpath("castle").."/castle_bridgenode.lua")
--dofile(minetest.get_modpath("castle").."/castle_towerbridgenode.lua")
...
dofile(minetest.get_modpath("castle").."/castle_grassystair.lua")
